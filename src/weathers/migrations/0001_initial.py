    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meteo_point_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='weather_data', to='weathers.meteopointprovider', verbose_name='Метео-точка-провайдер')),
            ],
            options={
                'verbose_name': 'Погодные данные',
                'verbose_name_plural': 'Погодные данные',
                'indexes': [models.Index(fields=['meteo_point_provider', 'timestamp_utc'], name='weathers_we_meteo_p_981de3_idx'), models.Index(fields=['parameter', 'timestamp_utc'], name='weathers_we_paramet_314a11_idx')],
            },
        ),
    ]
